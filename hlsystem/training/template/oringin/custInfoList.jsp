		...
		<template>	
			...
			<div class="dataTables_filter">
				<div>   
					...
					관리담당자 <input type="text" placeholder="" style="width: 120px;" v-model="pic_nm">
					
					<button type="button" class="btn btn-blue btn-icon icon-left" style="margin-left: 5px;" v-model="search_val" @click="getCustInfoList(true)">
						조건검색
				...
				<div style="margin-top: 10px;">	
					생년월일 <input type="text" placeholder="" style="width: 120px;" v-model="rrno"> 	
					관리부서 <input type="text" placeholder="" style="width: 120px;" v-model="dept_nm">
					<button type="button" class="btn btn-blue btn-icon icon-left" style="margin-left: 5px;" v-model="search_val" @click="getCustInfoListAll(true)">
						전체검색
						<i class="entypo-search"></i>
					</button> 					
				</div>         
				<div style="margin-top: 20px;">  
					...
					<button type="button" class="btn btn-blue btn-icon icon-left" style="margin-left: 5px;" @click="popCustmngCardPrint">
							관리카드출력
					<i class="entypo-vcard"></i>
					</button>   
					<button type="button" class="btn btn-blue btn-icon icon-left" style="margin-left: 5px;" @click="popDamdangSet">
							담당자설정
					<i class="entypo-user"></i>
					</button> 
					<button type="button" class="btn btn-orange btn-icon icon-left" style="margin-left: 5px;" @click="custInfoMng">
							고객관리 
					<i class="entypo-users"></i>
					</button>      
					<button type="button" class="btn btn-orange btn-icon icon-left" style="margin-left: 5px;" @click="picInfoMng">
							담당자관리
			...
			<table class="table table-bordered datatable dataTable" id="grid_app">
				...
				<tbody>   
					<tr v-for="item in dataList" @dblclick="gotoDtl(item.cust_mbl_telno)" style="cursor: pointer;">
						<td class="center"@dblclick.stop="return false;" ><input type="checkbox" :data-idx="item.cust_nm" name="is_check" @click.stop="onCheck" style="cursor: pointer;"></td>
				...
				<div class="clearAfter" >   
			      <div class="left">  
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="cust_mbl_telno" v-model="info.cust_mbl_telno">
						</div>
					</div>
					<div class="form-group">
					 ...
					 <div class="form-group">
						...
						<div class="col-sm-9">
							<textarea  id="cust_addr" v-model="info.cust_addr"style="width:100%;" ></textarea>
						</div>
					 </div>  
...
<template>
	<div class="modal-dialog4">
		<div class="modal-content">
			      ...
			      <div class="left">  
			      	<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<button type="button" class="btn btn-blue btn-icon icon-left" style="margin-left: 5px;" @click="damdangSave">
							등록
							<i class="entypo-search"></i>
							</button>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<button type="button" class="btn btn-blue btn-icon icon-left" style="margin-left: 5px;" @click="damdangDelete">
							삭제
							<i class="entypo-search"></i>
							</button>
						</div>  
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="jbps_ty_cd_nm" v-model="picInfo.jbps_ty_cd_nm">
						</div>  
					</div>
					<div class="form-group">
						<label for="err_eng_nm" class="col-sm-3 control-label">연락처 : </label>
						<div class="col-sm-9">
						    <input type="text" id="pic_mbl_telno" v-model="picInfo.pic_mbl_telno">
						</div>  
					</div>
					<div class="form-group">
						<label for="err_eng_nm" class="col-sm-3 control-label">E-mail : </label>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea  id="etc_tsk_cn" v-model="picInfo.etc_tsk_cn"style="width:100%;" ></textarea>
						</div>
					</div>
					<div class="form-group"> 
					<table class="table datatable dataTable">	
			...
			<div class="modal-footer">
       			<button type="button" class="btn btn-secondary" data-dismiss="modal" @click="popupPicClose">Close</button>
			</div>
		</div>
	</div>
</template>

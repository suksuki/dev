                ...
                <div class="flex flex-100">
                    ...
                    <div class="flex-wrap flex-33 flex flex-center flex-gap-10 flex-padding-10">   
                        <div class="form-group" style="width:45%;">
                            ...
                            <button 
                            type="button" class="btn btn-blue btn-icon icon-left form-control " v-model="search_val"  @click="getCustInfoList(true)">
                                조건검색
                        ...
                        <div class="form-group" style="width:45%;">
                            <button type="button" class="btn btn-blue btn-icon icon-left form-control" v-model="search_val"  @click="getCustInfoListAll(true)">
                                전체검색
                                <i class="entypo-search"></i>
                            </button>
